...
void executeParallel(size_t count, size_t numThreads, std::function<void(size_t)> const& f) {
...
void executeParallel(size_t count, std::function<void(size_t)> const& f) {
